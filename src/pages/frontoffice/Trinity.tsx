    ...
    <>
      ...
      <div className="pt-0 sm:pt-16">
        <div className="grid grid-cols-1 sm:grid-cols-3">
          <div className="py-24 px-14 flex items-center justify-center border border-gray-300">
            {t("Trinite.trad1")}
          </div>
          <div className="pt-20 pb-11 px-14 flex flex-col items-center justify-start border border-gray-300">
          ...
          <div className="pt-24 pb-20 px-14 flex flex-col items-center justify-start border border-gray-300">
            <div className="flex justify-between gap-10">
              <p>{t("Trinite.trad3")}</p>
              <p>660€</p>
            </div>
